/* ###########################################################################
 * add functionality to m$ RadioButtonList control
 * ###########################################################################
 */
using System;
...
namespace kuujinbo.asp.net.WebForms.controls {
  [
    ...
    ,ToolboxData("<{0}:radiobuttonlist ID='RadioButtonListID' runat='server' />")
  ]
  public class radiobuttonlist : RadioButtonList, Icontrol {
/*
